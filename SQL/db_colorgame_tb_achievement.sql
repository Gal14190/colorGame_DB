...
CREATE TABLE `tb_achievement` (
  ...
  `MID` int NOT NULL,
  PRIMARY KEY (`UID`,`MID`),
  KEY `user_won_medal_idx` (`UID`),
  KEY `medal_idx` (`MID`),
  CONSTRAINT `medal` FOREIGN KEY (`MID`) REFERENCES `tb_medal` (`MID`),
  CONSTRAINT `user` FOREIGN KEY (`UID`) REFERENCES `tb_users` (`UID`)
...
INSERT INTO `tb_achievement` VALUES (1,1),(1,2),(1,3),(2,2),(3,2),(5,3);
